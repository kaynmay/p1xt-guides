...
| [Intro to HTML/CSS: Making webpages](https://www.khanacademy.org/computing/computer-programming/html-css)                                                             |  Completed 10/12/21 |              |
...
### Tier 0 - Web Development - Deep Dive Into Modern Web Development - Full Stack Open 2020

Complete the [Deep Dive Into Modern Web Development - Full Stack Open 2020](https://fullstackopen.com/en) free online Fullstack course.

| Courses                                                                                                                                                                         |   Status   |   Evidence   |
| :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | :--------: | :----------: |
| Fundamentals of Web apps                                                                                                                                                        |      Completed 9/26/21     |              |
| Introduction to React                                                                                                                                                           |       Completed 10/12/21   |              |
